...
import {
  ...
  types,
  worldViews,
} from '../../../../contants/creatureContants';
...
export const BestiaryPageSearchForm: React.FC<IProps> = ({
  control,
  setValue,
  onResetButtonClick,
}) => {
  const arrayFrom0To30 = Array(31)
    .fill(null)
    .map((e, i) => String(i));
    ...
    <form className={styles.sortWrapper}>
      ...
      <div className={styles.filterItems}>
        ...
        <Controller
          control={control}
          name="habitat"
          render={({ field }) => <Input {...field} placeholder="Местность" />}
        />
