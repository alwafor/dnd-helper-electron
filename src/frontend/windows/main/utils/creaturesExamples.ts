...
export const creatureExampleDragon: ICreatureData = {
  imageUrl:
    'http://tentaculus.ru/monsters/img/cute_monsters/ANCIENT_COPPER_DRAGON.jpg',
  ...
  features: [
    ...
    {
      name: 'Легендарное Сопротивление (3/в день)',
      value:
  ...
  actions: [
    ...
    {
      name: 'Оружие дыхания',
      value: 'Дракон использует одно из следующих оружий дыхания.',
    },
  ],
  legendaryActions: [
    {
      name: 'Обнаружение',
      value: 'Дракон проводит проверку Мудрости (Внимательность).',
    },
    { name: 'Атака Хвостом', value: 'Дракон проводит атаку хвостом.' },
    {
      name: 'Атака Крыльями (Требует 2 действия)',
      value:
